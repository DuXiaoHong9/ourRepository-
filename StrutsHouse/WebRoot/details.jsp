...
<DIV class=intro>
<DIV class=lefter>
<H1><s:property value="hou.title"/></H1>
<DIV class=subinfo><s:property value="hou.pubdate"/></DIV>
<DIV class=houseinfo>
<P>户　　型：<SPAN><s:property value="hou.types.name"/></SPAN></P>
<P>面　　积：<SPAN><s:property value="hou.floorrage"/>m<SUP>2</SUP></SPAN></P>
<P>位　　置：<SPAN><s:property value="hou.street.dis.name"/><s:property value="hou.street.name"/></SPAN></P>
<P>联系方式：<SPAN><s:property value="hou.contact"/></SPAN></P></DIV></DIV>
<DIV class=side>
<P><A class=bold href="http://localhost:8080/House-2/#"><s:property value="hou.users.name"/></A></P>
<P>资质证书：有</P>
<P>内部编号:1000</P>
<P>联 系 人：<s:property value="hou.users.username"/></P>
<P>联系电话：<s:property value="hou.users.telephone"/><SPAN></SPAN></P>
<P>手机号码：<SPAN>暂无</SPAN></P></DIV>
<DIV class=clear></DIV>
<DIV class=introduction>
<H2><SPAN><STRONG>房源详细信息</STRONG></SPAN></H2>
<DIV class=content>
<P><s:property value="hou.description"/></P></DIV></DIV></DIV></DIV>
